...
class Navigation {
  ...
  setupHtml() {
    ...
    html += "</ul>";
    html +=
      '<div class="side-nav__contacts"><a class="side-nav__link" href="https://chrome.google.com/webstore/detail/mindful-internet-use/hieolpjdilnibgamiafklnlcmagdngoo">CLICK HERE TO RATE OR REVIEW MIU</a></div>';
